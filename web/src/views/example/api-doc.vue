    ...
    <div class="api-doc-container">
        <el-card class="box-card">
            ...
            <div class="doc-content" v-loading="loading">
                <iframe v-if="showSwaggerUI" :src="swaggerUIUrl" frameborder="0" width="100%" height="800px"></iframe>
    ...
    Object.keys(responses).forEach((code) => {
        ...
        parsed[code] = {
            ...
            example: response.content?.['application/json']?.schema?.example ||
                response.content?.['application/json']?.example || { code: 1, msg: 'success', data: {} },
        }
    })
    return parsed
}
