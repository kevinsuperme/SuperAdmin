        ...
        <div class="modules-header">
            <div class="table-header-buttons">
                ...
                <el-button-group class="ml10 publish-module-button-group">
                    <el-button @click="navigateTo('https://doc.superadmin.com/senior/module/start.html')" v-blur type="success">
                        <Icon name="fa fa-cloud-upload" color="#ffffff" size="14" />
                        <span class="table-header-operate-text">{{ t('module.Publishing module') }}</span>
                    </el-button>
                    <el-button @click="navigateTo('https://doc.superadmin.com/guide/other/appendix/getPoints.html')" v-blur type="success">
