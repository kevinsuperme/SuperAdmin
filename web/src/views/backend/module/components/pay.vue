        ...
        >
            <div>
                <div class="header-box">
                    <img
                        class="pay-logo"
                        :src="'https://superadmin.com/static/images/' + (state.common.payType == 'wx' ? 'wechat-pay.png' : 'alipay.png')"
                        alt=""
                    />
                </div>
                <div class="pay-box">
                    ...
                    <div class="right">
                        <img
                            class="pay-logo"
                            :src="'https://superadmin.com/static/images/screenshot-' + (state.common.payType == 'wx' ? 'wechat.png' : 'alipay.png')"
                            alt=""
                        />
                    </div>
                </div>
