...
export default {
    ...
    layouts: {
        ...
        'Login to the superadmin': '登录到 SuperAdmin 开源社区',
        'Please enter superadmin account name or email': '请输入 SuperAdmin 账户名/邮箱/手机号',
        'Please enter the superadmin account password': '请输入 SuperAdmin 账户密码',
        Login: '登录',
        Password: '密码',
        Username: '用户名',
        Register: '没有账户？去注册',
