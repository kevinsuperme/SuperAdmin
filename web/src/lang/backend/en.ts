...
export default {
    ...
    layouts: {
        ...
        'Login to the superadmin': 'Login to the superadmin',
        'Please enter superadmin account name or email': 'Please enter superadmin account name or email',
        'Please enter the superadmin account password': 'Please enter the superadmin account password',
        Login: 'Login',
        Password: 'Password',
        Username: 'Username',
        Register: 'Register',
