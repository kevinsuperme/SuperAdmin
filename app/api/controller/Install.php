        ...
        if (!$phpVersionCompare) {
            $phpVersionLink = [
                ...
                [
                    ...
                    'type'  => 'faq',
                    'url'   => 'https://doc.SuperAdmin.com/guide/install/preparePHP.html'
                ]
            ];
        }
        // php版本-end
        ...
        if (!$configIsWritable) {
            $configIsWritableLink = [
                [
                    ...
                    'type'  => 'faq',
                    'url'   => 'https://doc.SuperAdmin.com/guide/install/dirNoPermission.html'
                ]
            ];
        }
        // 配置文件-end
        ...
        if (!$phpPdo) {
            $phpPdoLink = [
                ...
                [
                    ...
                    'title' => __('Click to see how to solve it'),
                    'type'  => 'faq',
                    'url'   => 'https://doc.SuperAdmin.com/guide/install/missingExtension.html'
                ]
            ];
        }
        // PDO-end
        ...
        if (!$phpGd2) {
            $phpGd2Link = [
                ...
                [
                    ...
                    'title' => __('Click to see how to solve it'),
                    'type'  => 'faq',
                    'url'   => 'https://doc.SuperAdmin.com/guide/install/gdFail.html'
                ]
            ];
        }
        // GD2和freeType-end
        ...
        if (!$phpProc) {
            $phpProcLink = [
                [
                    ...
                    'type'  => 'faq',
                    'url'   => 'https://doc.SuperAdmin.com/guide/install/disablement.html'
                ],
                [
                ...
                [
                    ...
                    'type'  => 'faq',
                    'url'   => 'https://doc.SuperAdmin.com/guide/install/senior.html'
                ],
            ];
        }
        // proc_open-end
        ...
        if (!$npmVersionCompare || !$npmVersion) {
            $npmVersionLink = [
                ...
                [
                    ...
                    'title' => __('Click to see how to solve it'),
                    'type'  => 'faq',
                    'url'   => 'https://doc.SuperAdmin.com/guide/install/prepareNpm.html'
                ]
            ];
        }
        ...
        if (!$nodejsVersionCompare || !$nodejsVersion) {
            $nodejsVersionLink = [
                ...
                [
                    ...
                    'title' => __('Click to see how to solve it'),
                    'type'  => 'faq',
                    'url'   => 'https://doc.SuperAdmin.com/guide/install/prepareNodeJs.html'
                ]
            ];
        }
